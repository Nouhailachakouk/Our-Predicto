...
const performanceData = [
  { month: 'Jan', efficiency: 94, downtime: 6 },
  { month: 'Feb', efficiency: 96, downtime: 4 },
  { month: 'Mar', efficiency: 92, downtime: 8 },
  { month: 'Apr', efficiency: 98, downtime: 2 },
  { month: 'May', efficiency: 95, downtime: 5 },
  { month: 'Jun', efficiency: 97, downtime: 3 },
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">15.7kWh</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Monthly Downtime Analysis</CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
